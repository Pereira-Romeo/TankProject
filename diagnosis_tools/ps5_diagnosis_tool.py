#!/usr/bin/env python3
"""
PS5 DualSense controller (Bluetooth) diagnostic tool.

--- Pairing the PS5 controller via Bluetooth ---

    bluetoothctl
    power on
    agent on
    scan on
    # Hold the PS button + Create button on the controller until it flashes fast
...
the MAPPINGS["ps5"] entry in tank.py.
...
if pygame.joystick.get_count() == 0:
    ...
    print("Pair the DualSense over Bluetooth (see instructions at top of this file) then try again.")
    raise SystemExit
